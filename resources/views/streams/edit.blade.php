...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Update Stream') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('streams.update',$stream->id) }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $stream->name }}" required  autofocus>
