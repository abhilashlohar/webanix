...
<div class="row">
  <div class="col-md-4">
    <div align="center" style="background-color: #FFF;border-radius: 5px;padding: 50px 0px;border: solid 1px #cccccc;">
      <span style="font-size: 40px;color: #FF6468;">324590</span><br>
      <span style="font-size: 16px;color: #4D384B;">Students</span>
    </div>
  </div>
  <div class="col-md-4">
      <div align="center" style="background-color: #FFF;border-radius: 5px;padding: 50px 0px;border: solid 1px #cccccc;">
        <span style="font-size: 40px;color: #FF6468;">985398</span><br>
        <span style="font-size: 16px;color: #4D384B;">Marksheets</span>
      </div>
  </div>
  <div class="col-md-4">
      <div align="center" style="background-color: #FFF;border-radius: 5px;padding: 50px 0px;border: solid 1px #cccccc;">
        <span style="font-size: 40px;color: #FF6468;">12</span><br>
